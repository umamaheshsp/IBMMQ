/* @(#) samples/c/amqsget0.c, samples, p701, p701-105-110415 1.38.1.1 09/08/15 09:56:19 */
 /********************************************************************/
 /*                                                                  */
 ...
 int main(int argc, char **argv)
 {
   ...
   gmo.Options = MQGMO_WAIT           /* wait for new messages       */
               | MQGMO_SYNCPOINT   /* no transaction              */
               | MQGMO_COMPLETE_MSG 
               | MQGMO_CONVERT;       /* convert if necessary        */
   gmo.WaitInterval = 5000;          /* 15 second limit for waiting */
   ...
   while (CompCode != MQCC_FAILED)
   {
     ...
     printf("MQGET returned CompCode %d Reason %d\n", CompCode, Reason); 
    /* MQCMIT(Hcon, &CompCode, &Reason);
     printf("MQCMIT returned CompCode %d Reason %d\n", CompCode, Reason); */
