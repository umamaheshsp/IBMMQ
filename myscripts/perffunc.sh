...
#/'}  poll rc=||}! poll rc='/{ etime=$2; etid=$3; etime_1[etid]=$2; split($2, var, "."); split(var[1], var1, ":"); endtime_sec[etid]=var1[3]; endtime_ms[etid]=var[2]; 
/}  poll rc=/ || /}! poll rc=/{ rc=$7; etime=$2; etid=$3; etime_1[etid]=$2; split($2, var, "."); split(var[1], var1, ":"); endtime_sec[etid]=var1[3]; endtime_ms[etid]=var[2]; 
