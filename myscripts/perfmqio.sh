...
/OSName/{ dlen_t=$7; rlen_t=$8; }
/}  adiReadFile rc=/ || /}! adiReadFile rc=/{ rc=$7; etime=$2; etid=$3; etime_1[etid]=$2; split($2, var, "."); split(var[1], var1, ":"); endtime_sec[etid]=var1[3]; endtime_ms[etid]=var[2]; 
                          ...
                          if( etid in starttime_ms )
                           {
                            ...
                            print etid " " stime_1[etid] " " etime_1[etid] " " diff_sec ":" diff_ms " : " rc " : " dlen_t " : " rlen_t
                            starttime_ms[etid]=0;
                           }
                          }
END {
